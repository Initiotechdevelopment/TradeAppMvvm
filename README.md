# [Model-View-ViewModel (ie MVVM)](https://github.com/Sumeetbhut/Android-MVVM-architecture)
...
You can also check [**MVP**](https://github.com/Sumeetbhut/Android-MVP-Architecture)
