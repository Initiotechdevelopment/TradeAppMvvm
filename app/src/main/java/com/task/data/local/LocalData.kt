...
class LocalData @Inject constructor(val context: Context) {
    ...
    fun doLogin(loginRequest: LoginRequest): Resource<LoginResponse> {
        if (loginRequest == LoginRequest("sumeet@sumeet.com", "sumeet")) {
            return Resource.Success(LoginResponse("123", "sumeet", "bhut",
                    "Maher", "77", "12000", "Berlin",
                    "Germany", "sumeet@sumeet.com"))
        }
